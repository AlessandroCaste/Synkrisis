...
public interface bigraphListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link bigraphParser#extra_properties}.
	 * @param ctx the parse tree
	 */
	void enterExtra_properties(bigraphParser.Extra_propertiesContext ctx);
	/**
	 * Exit a parse tree produced by {@link bigraphParser#extra_properties}.
	 * @param ctx the parse tree
	 */
	void exitExtra_properties(bigraphParser.Extra_propertiesContext ctx);
	/**
	 * Enter a parse tree produced by {@link bigraphParser#extra_statements}.
	 * @param ctx the parse tree
	 */
	void enterExtra_statements(bigraphParser.Extra_statementsContext ctx);
	/**
	 * Exit a parse tree produced by {@link bigraphParser#extra_statements}.
	 * @param ctx the parse tree
	 */
	void exitExtra_statements(bigraphParser.Extra_statementsContext ctx);
	/**
