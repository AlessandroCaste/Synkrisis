...
import core.brsinterpeter.Bigmc;
import core.brsinterpeter.BRSInterpreterInterface;
...
public class Main {
    ...
    public static void execution(ExecutionSettings executionSettings) {
        ...
        if (setup.isSuccessful()) {
            ...
            if (acceptableModel) {
                ...
                BRSInterpreterInterface BRSInterpreterInterface = new Bigmc(executionSettings, modelTree);
                if (BRSInterpreterInterface.needsTranslation())
                    BRSInterpreterInterface.translate();
                BRSInterpreterInterface.execute();
                ...
                if(BRSInterpreterInterface.isSuccessful()) {
    ...
    private static boolean dotImporting(ExecutionSettings executionSettings) {
        ...
        if(dotImporter.isSuccessful())
            ...
            System.out.println("[FATAL ERROR] Can't import the transition file");
